...
def main():
    ...
    group.add_argument('--obj-dir', help='Directory containing OBJ files')
    group.add_argument('--obj-file', help='Single OBJ file to process')
    ...
    if args.obj_file:
        ...
        colorizer = BuildingColorizer(obj_path.parent, args.geojson)
        colorizer.process_building(obj_path)
